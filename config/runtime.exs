...
#
#     PHX_SERVER=true bin/scholarly_search start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :scholarly_search, ScholarlySearchWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :scholarly_search, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :scholarly_search, ScholarlySearch.Mailer,
